...
# --- per-boxer DNA ---
DNA = {
    "guard_perfect": 0.73, "guard_ok": 1.03, "guard_max_ratio": 1.33,
    "stance_ratio_min": 1.20, "stance_ideal_min": 1.50, "stance_ideal_max": 2.00, "stance_ratio_max": 2.30,
    "shoulder_tilt_ok": 0.15, "shoulder_tilt_max": 0.30,
    "head_height_good": 0.25, "head_height_min": 0.15,
    "bounce_target": 0.10, "bounce_min": 0.04,
}

DYN_EXTEND_THRESH = 0.28
DYN_HOOK_THRESH   = 0.42
STRAIGHT_ANGLE    = 140
WINDOW_TITLE      = "Bivol Coach 2"
HEADER_LABEL      = "BIVOL AI COACH 2"
