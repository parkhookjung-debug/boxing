...
GARCIA = {
    "guard_perfect":      1.04,
    "guard_ok":           1.40,
    "guard_max_ratio":    1.75,
    "stance_ratio_min":   0.90,
    "stance_ideal_min":   1.05,
    "stance_ideal_max":   1.45,
    "stance_ratio_max":   1.75,
...
DYN_EXTEND_THRESH = 0.25   # 잽/크로스: shoulder_w 대비 6프레임 팔 펴짐 비율 (가르시아 빠른 펀치)
DYN_HOOK_THRESH   = 0.40   # 훅: shoulder_w 대비 4프레임 손목 스윙 비율
STRAIGHT_ANGLE  = 112    # CSV p85: 111.5° → 가르시아는 훅처럼 팔 약간 구부려 냄
...
with vision.PoseLandmarker.create_from_options(options) as landmarker:
    while cap.isOpened():
        ...
        cv2.putText(frame, "GARCIA AI COACH  +PUNCH", (10, 28),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.68, (0, 180, 60), 2)
