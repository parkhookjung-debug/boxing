...
# --- per-boxer DNA ---
DNA = {
    "guard_perfect": 0.70, "guard_ok": 1.02, "guard_max_ratio": 1.32,
    "stance_ratio_min": 1.15, "stance_ideal_min": 1.45, "stance_ideal_max": 1.95, "stance_ratio_max": 2.25,
    "shoulder_tilt_ok": 0.16, "shoulder_tilt_max": 0.32,
    "head_height_good": 0.23, "head_height_min": 0.13,
    "bounce_target": 0.11, "bounce_min": 0.045,
}

DYN_EXTEND_THRESH = 0.25
DYN_HOOK_THRESH   = 0.40
STRAIGHT_ANGLE    = 112
WINDOW_TITLE      = "Garcia Coach 2"
HEADER_LABEL      = "GARCIA AI COACH 2"
